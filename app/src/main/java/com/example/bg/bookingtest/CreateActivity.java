...
public class CreateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //setup google calendar layout to display results
        createApiLayout();

        final Button entryButton = (Button) findViewById(R.id.addEntryButton);
        ...
        final Button entriesButton = (Button) findViewById(R.id.viewEntriesButton);
...
// credentials.
        ...
        mOutputText.setText(("Event created: \n"+ event.getHtmlLink().toString()));
    }

    //Creates layout for displaying google api results
    private void createApiLayout(){
        //google calender
        ...
        activityLayout.addView(mBackButton);
